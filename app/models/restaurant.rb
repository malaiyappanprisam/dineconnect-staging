class Restaurant < ActiveRecord::Base
  ...
  has_many :open_schedules, -> { order(:day).order(:time_open) } , :dependent => :destroy
  ...
  accepts_nested_attributes_for(:open_schedules, reject_if: :reject_open_schedules, allow_destroy: :true)
